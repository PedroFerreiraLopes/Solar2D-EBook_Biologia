...
function scene:create( event )
    ...
    local text = display.newImage( backgroundGroup, "assets/Pag1/text.png");
    ...
    botoes.changeNavListener(prevButton, composer, "Paginas.Capa.Capa");
    botoes.changeNavListener(nextButton, composer, "Paginas.Pag1.Pag1");
    ...
    botoes.setSound({soundButtonGroup, soundOn, soundOff}, "audios/Pag1Text.mp3");
